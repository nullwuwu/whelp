...
module.exports = (api, config) => {
    ...
    const entry = struct.optional(struct.union([str, arr, obj]))
    ...
    const output = struct(
        {
            ...
            moduleName: struct.optional(str),
            publicUrl: str,
            target: struct.enum([
                'web',
                'node',
            ...
            fileNames: struct.optional(
                struct.object({
                    js: struct.optional(str),
                    css: struct.optional(str),
                    font: struct.optional(str),
                    image: struct.optional(str),
                })
            ),
            html: struct.optional(struct.union([bool, obj])),
        },
        {
            dir: 'dist',
    ...
    const babel = struct(
        {
            ...
            transpileModules: struct.optional(
                struct.list([struct.union([str, reg])])
            ),
            namedImports: struct.optional(obj),
            babelrc: struct.optional(bool),
            configFile: struct.optional(bool),
        },
        {
            jsx: 'react',
        }
    ...
    const devServer = struct(
        {
            ...
            open: 'boolean',
            historyApiFallback: struct.optional(
    ...
    const Struct = struct(
        {
            ...
            configureWebpack: struct.optional(
                struct.union(['object', 'function'])
            ),
            assets,
